...
<form action="edit" method="post">
    <table>
        ...
        <tr>
            <th>USERCD:</th>
            <td><input type="text" name="USERCD" value="{{$data->USERCD}}"></td>
            @error('USERCD')
                <td>{{$message}}</td>
            @enderror
        </tr>
        <tr>
            <th>USERNM:</th>
            <td><input type="text" name="USERNM" value="{{$data->USERNM}}"></td>
            @error('USERNM')
                <td>{{$message}}</td>
            @enderror
        </tr>
        <tr>
            <th>USERKANA:</th>
            <td><input type="text" name="USERKANA" value="{{$data->USERKANA}}"></td>
            @error('USERKANA')
                <td>{{$message}}</td>
            @enderror
        </tr>
